...
@Component({
  selector: "app-crear-cliente-produccion",
  templateUrl: "./crear-cliente-produccion.component.html",
  styleUrls: ["./crear-cliente-produccion.component.css"]
})
export class CrearClienteProduccionComponent implements OnInit {
  ...
  constructor(
    ...
    private DialogRef: MatDialogRef<CrearClienteProduccionComponent>
  ) {}
