...
import { AddClientesPedidosComponent } from "./add-clientes-pedidos/add-clientes-pedidos.component";
...
@Component({
  ...
  styleUrls: ["./clientes-pedidos.component.css"]
})
export class ClientesPedidosComponent implements OnInit {
  ...
  constructor(
    public DialogRef: MatDialogRef<ClientesPedidosComponent>,
  ...
  addClient() {
    let dialogRef = this.dialog.open(AddClientesPedidosComponent, {
      width: "auto",
      data: "text",
      autoFocus: false
    });
