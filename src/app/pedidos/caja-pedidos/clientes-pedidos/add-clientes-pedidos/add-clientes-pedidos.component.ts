...
@Component({
  selector: "app-add-clientes-pedidos",
  templateUrl: "./add-clientes-pedidos.component.html",
  styleUrls: ["./add-clientes-pedidos.component.css"]
})
export class AddClientesPedidosComponent implements OnInit {
  ...
  constructor(
    ...
    private DialogRef: MatDialogRef<AddClientesPedidosComponent>
  ) {}
